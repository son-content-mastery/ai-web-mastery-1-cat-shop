...
อนุญาตให้นำโค้ดและโครงสร้างของโปรเจกต์นี้ไปใช้เพื่อการศึกษา ทดลอง สอน ดัดแปลง และต่อยอดได้ หากนำไปเผยแพร่หรือใช้ประกอบการสอน กรุณาให้เครดิต [Web Mastery](https://webmastery.dev/)

รูปภาพ โลโก้ ชื่อแบรนด์ เนื้อหา และไฟล์ใน `references/` อาจมีสิทธิ์ของเจ้าของผลงานหรือเจ้าของแบรนด์เดิม ควรตรวจสอบสิทธิ์ของส่วนนั้นแยกต่างหากก่อนนำไปเผยแพร่หรือใช้เชิงพาณิชย์
