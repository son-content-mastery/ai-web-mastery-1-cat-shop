...
Read `AGENTS.md` and root `DESIGN.md` before UI work. Never edit `references/`, `node_modules/`, `dist/`, or `.astro/`. Keep LINE/domain placeholders centralized, use scoped changes, and synchronize docs after route, component, or design-state changes.
